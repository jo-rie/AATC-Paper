...
The data is publicly available and also includes numerical measurement data such as heart rate, blood pressure, and oxigen saturation in a waveform database \parencites[][]{Moody2017}[available through][]{Goldberger2000}.
...
For critical patients, changes in the blood pressure can be crucial for the treatment.
...
The number of available records with measurements of \ac{abp} and \ac{nbp} for the lags is listed in Table~\ref{tab:app-mimic-data-summary}.
...
For the measurements with lag one minute, the confidence intervals have lower bounds of 0.5 or slightly above.
For larger lags, the trending ratio increases.
The difference between positive and negative trending ratio is small for all types and lags, with overlapping confidence intervals in all cases.
...
This is in line the trending ratios, but the confidence intervals overlap.

\begin{figure}
    \centering
    \includegraphics{plots/mimic/plot_4q}
    \caption{Four-quadrant plots for the different lags and the systolic and mean blood pressure measurements. The upper row contains systolic measurements, the lower row mean measurements. The columns contain the lags one, five, and 15 minutes.}
...
Some authors argue to exclude not only the measurements below 10\%-quantile of the absolute differences but also the points above the 90\%-quantile.
...
The positive and negativ trending ratios have overlapping confidence intervals and the conditional trending plots do not contain prominent deviations in the course.

...
\unsure{irgendwie wird die Datenstruktur nicht ganz klar beschrieben. Habe ich hier Datensätze von verschiedenen Patienten und bei jeem Datensatz gibt es dann fehlende Punkte von ABP oder NBP?}
...
\unsure{vielleicht genauer: we exclude the smallest 10 \% of the absolute differences in the trend assessment.}

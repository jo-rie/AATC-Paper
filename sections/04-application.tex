...
For the evaluation period of 159 days, the trending ratio confidence intervals overlap, and thus, no conclusions can be drawn from the trending evaluation.
...
In the study by \textcite{Rostami-Tabar2023}, several models are used for predicting hourly outcomes.
...
The variability of differences decreases for the larger lag for most models; only for the ETS model it increases.

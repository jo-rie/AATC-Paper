...
The pandemic's spread and severity were measured by various indicators. 
...
Table~\ref{tab:app-covid-models} in the appendix lists the different abbreviations together with the respective names in the COVID19-Nowcasting-Hub.
...
\textcite{Wolffram2023} describes the design of the nowcast tasks and the data submission guidelines for the teams that were stated in a preregistered study. 
...
The nowcasts are resolved with regard to all inhabitants but also with regard to certain geographical and age breakdowns.
...
Trending assessment evaluat to point evaluation measures.

...
Asymmetries are especially of interest in assessing whether some models are better at recognizing a fall than a rise or vice versa.
...
We start by analyzing the marginal distributions for the changes of forecasts and true values for the horizons of three and seven days in Table~\ref{tab:app-eda-marginals}, again.
Thereby, the computed difference aligns with Section~\ref{subset:notation}, defined as the difference between the forecasted mean and true value of three and seven days before, as the true value is available when issuing the forecast.
...
\todo{Schwer verstaendlich (Auch Abbildung~\ref{tab:app-eda-marginals})}
...
Remember that low a \ac{bs} and a plot along the diagonal are signs for good trending.

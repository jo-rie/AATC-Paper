...
However, trending evaluation reveals a method's capability of predicting the development of the target variable, for example, the number of cases of an epidemic, that can be the foundation of decisions on the introduction or cancellation of policy measures. \todo{Satz ist noch nicht gut}

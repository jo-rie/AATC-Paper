...
\item We present different variants of trend measures that consider noiseless data as well as noisy and small non-informative changes.

\item We introduce the conditional trend plot, a new graphical method for assessing local trends.

\item We introduce bootstrap methods for calculating confidence intervals. Confidence intervals for the measurements from the previous sections.

\item We extend the concept of trending to probabilistic predictions.

\item We apply trend evaluation to three different applications: Measurement, nowcasting and prediction data. 

\item The source code for the replication of the results of our study as well as a ready-to-use code for trendability detection are available in our public repository at [Link will be inserted] available.
\end{itemize}

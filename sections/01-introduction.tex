...
\begin{itemize}
    \item  we formalize the trending and present various methods for measuring and visualizing trending that can be applied to the evaluation of trending ability of methods in measurements, nowcasts and forecasts. 
    \item The presented methods will be applied to a variety of real data examples. 

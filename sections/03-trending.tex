...
Second, in the context of nowcasting or forecasting, several signals for the same time $t + l$ are often available at different times of generation.
...
For measurement, usually, a test method is evaluated against a gold standard to test whether the test method could replace the gold standard.
...
\todo{Signal/Prediction vereinheitlichen}
...
In addition to these straight shapes, exclusion areas such as ellipsis could have more difficult shapes.
...
\todo{Übergang zu Bootstrapping}
Confidence intervals can be used to account for the estimation uncertainty of the measures above.

...
\todo{Was heißt unbalanced; warum ist das bei uns nicht?}
...
\todo{kann man vielleicht mu für verschiedene Varianten von Exclusion Area ausrechnen als Vergleich? im Anhang?}
In addition to these straight shapes, exclusion areas could also be determined based on an error model of the components.
For example, one could exclude points likely to be in another quadrant or within a specific quantile of a distribution around the zero point, for example, exclude the points within the 95\% ... . \discuss{vielleicht genauer bei der Verwendung von Quantilen}

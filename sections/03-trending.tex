...
A large difference in $\sum_{\mathcal} \ind{\diffyt > 0}$ and $\sum_{\mathcal} \ind{\diffyt > 0}$ is unlikely in the trending setting as $\diffy$ is obtained from differencing time series data.

...
For nowcasting, target times are usua; while $t$ is usually at least $\tau$ in forecasting. \unsure{Nowcast macht Schätzung i. d. R. so lange, bis der echte Wert bekannt wird oder?}
...
If the true value is given as a distribution because it is yet unknown, the probabilities $p_t$ can be computed by integration.

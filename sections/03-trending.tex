...
For example, one could exclude points likely to be in another quadrant or within a specific quantile of a distribution around the zero point, for example, exclude the points within the central 95\% ... . \discuss{vielleicht genauer bei der Verwendung von Quantilen}

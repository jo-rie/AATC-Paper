...
\abstract{ 
In addition to measurements, nowcasts, or forecasts being numerically precise, it is essential how well they reflect changes in the underlying values.
...
% Measurement weniger abgetrennt
...
% AATC weg als Abkürzung


This paper focuses on pure assessment of \ac{atc} accompanying traditional scores.
The assessment of \ac{atc} adds valuable information on the methods' capability of predicting the development of the target value, for example, the number of cases of an epidemic, where increases can be an early sign of the beginning of a wave.

In this article, we formalize \ac{atc} and present different variants of assessment of \ac{atc} measures that consider either noiseless data or data with noise and small non-informative changes (see Section~\ref{sec:aatc}).
...
\section{Assessment of the \acf{atc}}\label{sec:aatc}

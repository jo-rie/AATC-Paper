...
While the current practice of evaluating signals is based on averaging over time-step-separated measures, we review and introduce trending measures that consider whether the direction of development fits the quantity of interest. 

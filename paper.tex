...
\begin{abstract}
Trending refers to the ability of a signal to predict the direction of change for the true variable accurately. 
An appropriate assessment of the trending ability is crucial for measurements, nowcasts, and forecasts for decision-makers. 
While the current practice of evaluating signals is based on averaging over time-step-separated measures, we review and introduce trending measures that consider time series differences for certain lags. 
We formalize the concept of trending for all application areas and quantify the trending ability for signals. 
We review and present new visualization techniques to assess the local trending behaviors and quantify estimation uncertainty by bootstrapping. 
...
We formalize the concept of trending independently of the application domain and investigate quantification approaches for noise-free and noisy data. We introduce a new graphical method for evaluating trending, the conditional trending plot, which can represent the simultaneous evaluation of different intervals and asymmetries. Bootstrap methods for calculating confidence intervals for trending measures are also presented. We show the results of applying our method to several practical examples.



\section{Introduction}\label{sec:introduction}
\todo{State that we want to accompany the current evaluation with a new measure, not replace other measures}

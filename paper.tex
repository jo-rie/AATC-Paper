...
In forecasting and nowcasting, the evaluation of the measurement performance is based on statistical methods quantifying the accuracy such as the \ac{rmse}, probabilistic scoring rules, and calibration measures~\citep{Gneiting2007, Gunther2021, Wolffram2023}.

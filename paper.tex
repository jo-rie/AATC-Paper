...
In this article, we focus on predicting the correct direction of changes and refer to it as the ability to track changes. 

In this article, we focus on whether they predict the correct direction of changes and refer to it as the ability to track changes. 
...
Three medical or healthcare problems illustrate the methods: COVID-19-nowcasting, emergency department arrival forecasting, and invasive and non-invasive blood pressure measurements.
}

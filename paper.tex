...
\abstract{
Measurements, nowcasts, and forecasts aim to indicate a value of interest's change through direction and magnitude.
The direction of change alone is easily and intuitively interpretable information on the development and can be an early sign of regime switching.
We refer to a measurement's, nowcast's, or forecast's ability to predict the right direction of development as the ability to track changes.

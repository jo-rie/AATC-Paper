...
In forecasting and nowcasting the evaluation of performance or goodness is usually based on statistical methods quantifying the accuracy such as the \ac{rmse}, probabilistic scoring rules, and calibration measures~\citep{Gneiting2007, Gunther2021, Wolffram2023}, see also~\citep{SteyerbergEwoutW.2010AtPo} for an overview in the medical context together with less known measures.
However, although techniques like ROC curves for binary direction models or more general concordance measures (e.g., \citep{Goenen2005}) are used, there is no general measure directly framed to assesses the method's \ac{atc}.
...
When evaluating the performance or goodness of a measurement method like in classical mathod comparation studies, comparative statistics such as Bland-Altman analysis~\citep{Bland1986} and the percentage error \parencite{Critchley1999} are commonly used. In this strand of literature,  the best way to assess the \ac{atc} of measurement methods is a field of active ongoing research~\citep{Critchley20101180, CRITCHLEY2011536, Saugel2015, Saugel2018, Hiraishi2021}.
